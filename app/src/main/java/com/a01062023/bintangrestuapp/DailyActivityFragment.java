...
public class DailyActivityFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ArrayList<DailyActivityList> dailyActivityList
                = Constraint_DailyActivity.getDailyActivityListData();

        Adapter_DailyActivity itemAdapter = new Adapter_DailyActivity(dailyActivityList);
        // Set the LayoutManager that
        // this RecyclerView will use.
        RecyclerView recyclerView
                = view.findViewById(R.id.recycleView_daily);
